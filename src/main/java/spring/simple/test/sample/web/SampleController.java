package spring.simple.test.sample.web;
...
import spring.simple.test.sample.service.SampleService;
...
public class SampleController {
    ...
    public String form(
            @RequestParam(value = "sampleNo", required = false, defaultValue = "0") int sampleNo,
            ModelMap model)
            throws Exception {
